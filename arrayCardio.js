  // Get your shorts on - this is an array workout!
    ...
    const inventors = [
      ...
      const inventors1500s = inventors.filter((e) =>{
        e.year > 1500 && e.year < 1600
    ...
    //   console.log(inventors1500s)
      ...
      const firstLast = inventors.map(e => {
    ...
    //   console.log(youngToOld)
      ...
      const sumOfYears = inventors.reduce((a,c) => {
         let yearsLived = c.passed - c.year
         return a + yearsLived
    ...
    //   console.log(sortedLastNames)
      ...
      data.forEach((e) => {
        return countOccurrences[e] = (countOccurrences[e] || 0) + 1
      })
      ...
      const array = ['apple', 'banana', 'orange', 'apple', 'banana', 'apple'];
        ...
        const countOccurrences2 = array.reduce((acc, item) => {
